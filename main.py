...
students = [
    Student("Student 1", 12, "Python"), Student("Student 2", 16, "Python"),
    Student("Student 3", 15, "Python"), Student("Student 4", 14, "Python")
]
...
table.add_homework(Homework("Homework1", "Description1", 2, False))
table.add_homework(Homework("Homework2", "Description2", 2, False))
